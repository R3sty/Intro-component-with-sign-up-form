						...
						<form onSubmit={handleSubmit} className="lg:w-full">
							...
							<div className="relative">
								<input
									...
									id="firstName"
									type="text"
									placeholder={showError && error ? '' : 'First name'}
									value={firstName}
									onBlur={handleBlur}
									onChange={(e) => setFirstName(e.target.value)}
								></input>
							...
							<div className="relative">
								<input
									...
									id="lastName"
									type="text"
									placeholder={showError && error ? '' : 'Last Name'}
									value={lastName}
									onBlur={handleBlur}
									onChange={(e) => setLastName(e.target.value)}
								></input>
							...
							<div className="relative">
								<input
									...
									id="password"
									type="password"
									placeholder={showError ? '' : 'Password'}
									value={password}
									onBlur={handleBlur}
									onChange={(e) => setPassword(e.target.value)}
								></input>
